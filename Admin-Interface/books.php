...
<body>
    ...
    <div class="">
        <h1 class="hed">Admin Panel<img src="../pic/logo1.png" class="log"><h1>
    </div>
    <hr color="white">
    <?php session_start(); 
    if (isset($_SESSION['name']) == false) { ?>
        <div class="text-center">
            <h1><br><a href="../login/login.php" style="color:red;">Please Login First</a><br></h1>
        </div>
    <?php } else { ?>
        ...
        <div class="container">
            ...
            <table class="table table-hover">
                ...
                ?>
                    <tr>
                        ...
                        <td colspan="2"><?php echo substr($row['synopsis'], 0, 60) . '...'; ?></td>
            ...
            <form action="template/BookinsertQuery.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label>Image</label>
                        <p>upload Photo:&nbsp;&nbsp;<input type="file" name="photo" value="" required /></p>
                    </div>
                </div>
                <div class="form-group">
